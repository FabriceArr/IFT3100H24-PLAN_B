...
void Application::dragEvent(ofDragInfo dragInfo)
{
	...
	// importer le premier fichier dï¿½posï¿½ sur la fenï¿½tre si c'est une image (attention : aucune validation du type de fichier)
	renderer.image.load(dragInfo.files.at(0));

	// redimensionner la fenï¿½tre selon la rï¿½solution de l'image
